...
`OmicsProcessing::plot_omics_distributions()` to inspect how one or more
features behave across run order.

These plots are useful when you want to answer practical questions
such as:
...
[Function reference for `build_omics_synthetic()`](../reference/build_omics_synthetic.html)
...
knitr::include_graphics("before_minimum.png")
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("before_qc.png")
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("before_plate.png")
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("before_batch.png")
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("before_multi.png")
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("before_after_multi.png")
```
